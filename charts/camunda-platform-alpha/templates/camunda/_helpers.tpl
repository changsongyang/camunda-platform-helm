...
- name: {{ .Release.Name }}
  ...
  {{- if .Values.operate.enabled }}
  {{-  $proto := (lower .Values.operate.readinessProbe.scheme) -}}
  ...
  {{- if .Values.tasklist.enabled }}
  {{-  $proto := (lower .Values.tasklist.readinessProbe.scheme) -}}
  ...
  {{- if .Values.zeebe.enabled }}
  {{-  $proto := (lower .Values.zeebeGateway.readinessProbe.scheme) -}}
  ...
  {{-  $proto := (lower .Values.zeebe.readinessProbe.scheme) -}}
