...
- Helm values: [11.0.5](https://artifacthub.io/packages/helm/camunda/camunda-platform/11.0.5#parameters)
...
```shell
cosign verify-blob camunda-platform-11.0.5.tgz \
  --bundle camunda-platform-11.0.5.cosign.bundle \
